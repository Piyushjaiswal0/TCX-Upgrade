...
def create_file_dialog_entry(parent, label_text, row, column, var=None, button_text="Browse", is_save=False):
...
workflow_directory_var = create_file_dialog_entry(workflow_tab, "Repository Directory Path", 2, 0, is_save=False)
...
workspace_directory_var = create_file_dialog_entry(workspace_tab, "Repository Directory Path", 1, 0, is_save=False)
